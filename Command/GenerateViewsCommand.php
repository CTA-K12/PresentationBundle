...
class GenerateViewsCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('mesd:presentation:generate')
            ->setDescription('Generate templates into app/Resources for override')
            ->addOption('force', 'f', InputOption::VALUE_OPTIONAL, 'Force the generation of views')
        ;
    }
